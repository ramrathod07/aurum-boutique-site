...
import { Gem, Facebook, Instagram, Youtube, Twitter } from "lucide-react";
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-playfair text-xl font-bold">Lumière Jewels</span>
            </div>
            <p className="text-muted-foreground text-sm mb-4">
              Exquisite handcrafted jewellery. Timeless elegance meets modern luxury.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li>
                <a href="mailto:info@lumierejewels.com" className="hover:text-primary transition-colors">
                  info@lumierejewels.com
                </a>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-border mt-8 pt-8 text-center">
          <p className="text-sm text-muted-foreground">
            &copy; {currentYear} Lumière Jewels. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
